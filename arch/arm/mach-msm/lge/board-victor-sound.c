...
static struct marimba_platform_data marimba_pdata = {
	...
	.marimba_setup = NULL,
	.marimba_shutdown = NULL,
	.bahama_setup = NULL,
	.bahama_shutdown = NULL,
	.marimba_gpio_config = msm_marimba_gpio_config_svlte,
	.bahama_core_config = NULL,
	.fm = &marimba_fm_pdata,
...
static void __init lge_victor_amp_gpio_i2c_init(int bus_num)
{
	...
	if(lge_bd_rev >= LGE_REV_B)	{
		/* amp wm 9093 */
		init_gpio_i2c_pin(&lge_amp_i2c_pdata, lge_amp_i2c_pin[1], &lge_amp_i2c_bdinfo[1]);
		i2c_register_board_info(bus_num, &lge_amp_i2c_bdinfo[1], 1);
	}
	else		{
		/* amp tpa 2055 */
		init_gpio_i2c_pin(&lge_amp_i2c_pdata, lge_amp_i2c_pin[0], &lge_amp_i2c_bdinfo[0]);
		i2c_register_board_info(bus_num, &lge_amp_i2c_bdinfo[0], 1);
	}
